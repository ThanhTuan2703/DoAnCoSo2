                ...
                <div class="col-xl-12">
                    <div class="tatca them11">
                        ...
                        {{-- <div class="themmoi "><button class="text-white btn btn-info add-new"> <i
                                    ...
                                    <div class="themmoi "><button><a href="{{ route('register.user') }}" class="text-white btn btn-info ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display: flex">
                                    <a href="{{ route('quanly.edit',$row->id) }}" title="Edit" class="edit"><i
                                            class="fa-solid fa-pen-to-square"></i></a>
                                            <form method="POST" action="{{ route('quanly.destroy',$row->id) }}">
                                                @csrf
                                                @method('delete')
