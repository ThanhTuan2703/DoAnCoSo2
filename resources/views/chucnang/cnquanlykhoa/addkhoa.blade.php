            ...
            <div class="row ">
                <div class="col-12 boder-table">
                    <div class="table-responsivess">
                        <div class="row mt-2">
                            <div class="col-lg-12">
                                <h2 style="display: flex; height: 34px; align-items: center; font-size:25px">Thêm mới khoa
                                </h2>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('khoa.store') }}" method="post">
                            ...
                            <div class="container-xl">
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        @if ($errors->has('tenkhoa'))
                                            <span class="text-danger">{{ $errors->first('tenkhoa') }}</span>
                                        @endif
                                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input style="width:25%" type="text" name="makhoa"><br>
                                        @if ($errors->has('makhoa'))
                                        <span class="text-danger">{{ $errors->first('makhoa') }}</span>
                                         @endif
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input style="width:25%" type="datetime-local" name="ngaythanhlap"><br>
                                        @if ($errors->has('ngaythanhlap'))
                                        <span class="text-danger">{{ $errors->first('ngaythanhlap') }}</span>
                                         @endif
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea id="" name="motakhoa" style="width: 99%;"></textarea>
                                        @if ($errors->has('motakhoa'))
                                        <span class="text-danger">{{ $errors->first('motakhoa') }}</span>
                                         @endif
                                    </div>
                                </div>
                                <div class="Dep-form d-flex justify-content-center mt-4">
                                    ...
                                    <div class="mr-3">
                                        <a href="{{ route('khoa.create') }}" class="btn btn-primary ">Làm mới</a>
                                    </div>
                                    <div class="mr-3">
