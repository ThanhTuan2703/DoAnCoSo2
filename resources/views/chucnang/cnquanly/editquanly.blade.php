                ...
                <div class="col-12 boder-table">
                    <div class="table-responsivess">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2>Update quản lý</h2>
                                </div>
                            </div>
                        </div>
                        <form action="{{ route('quanly.update', $edituser->id) }}" method="post">
                            @csrf
                            @method('put')
                            <div class="form-group mb-3">
                                <input value="{{$edituser->name}}" type="text" placeholder="Name" id="name" class="form-control"
                            ...
                            <div class="form-group mb-3">
                                <input value="{{$edituser->email}} type="text" placeholder="Email" id="email_address" class="form-control"
                            ...
                            <div class="form-group mb-3">
                                <input value="{{$edituser->password}} type="password" placeholder="Password" id="password" class="form-control"
                            ...
                            <div class="Dep-form d-flex justify-content-center mt-4">
                                ...
                                <div class="mr-3">
                                    <a href="{{ route('quanly.edit', $edituser->id) }}" class="btn btn-primary ">Làm mới</a>
                                </div>
                                <div class="mr-3">
