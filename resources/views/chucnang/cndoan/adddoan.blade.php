            ...
            <div class="row">
                <div class="col-12 boder-table">
                    <div class="table-responsivess">
                        <div class="row mt-2">
                            <div class="col-lg-12">
                                <h2 style="display: flex; height: 34px; align-items: center; font-size:25px">Thêm mới đồ án
                                </h2>
                            </div>
                        </div>
                    </div>
                    <form action="{{ route('doan.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="container-xl">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="madoan" style="width: 35%" type="text"><br>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="tendoan" style="width: 25%" type="text"><br>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="fileimage" style="width: 25%" type="file"><br>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="filedoan" style="width: 35%" type="file"><br>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="diem" style="width: 25%" type="text"><br>
                                    @if ($errors->has('diem'))
                        ...
                        <div class="Dep-form d-flex justify-content-center mt-4">
                            ...
                            <div class="mr-3">
                                <a href="{{ route('doan.create') }}" class="btn btn-primary ">Làm mới</a>
                            </div>
                            <div class="mr-3">
