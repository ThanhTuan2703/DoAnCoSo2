            ...
            <div class="row">
                <div class="col-12 boder-table">
                    <div class="table-responsivess">
                        <div class="row mt-2">
                            <div class="col-lg-12">
                                <h2 style="display: flex; height: 34px; align-items: center; font-size:25px">Thêm mới niên
                                    khóa</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('nienkhoa.store') }}" method="post">
                        ...
                        <div class="container-xl">
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="nienkhoa" style="width: 25%" type="text" placeholder="Vd: 2022-2023">
                        ...
                        <div class="Dep-form d-flex justify-content-center mt-4">
                            ...
                            <div class="mr-3">
                                <a href="{{ route('nienkhoa.create') }}" class="btn btn-primary ">Làm mới</a>
                            </div>
                            <div class="mr-3">
