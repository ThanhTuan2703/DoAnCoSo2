            ...
            <div class="row">
                <div class="col-12 boder-table">
                    <div class="table-responsivess">
                        <div class="row mt-2">
                            <div class="col-lg-12">
                                <h2 style="display: flex; height: 34px; align-items: center; font-size:25px">Thêm mới hệ đào
                                    tạo</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('hedaotao.store') }}" method="post">
                        ...
                        <div class="container-xl">
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="tenhedaotao" style="width: 35%" type="text">
                                    @if ($errors->has('tenhedaotao'))
                                        <span class="text-danger">{{ $errors->first('tenhedaotao') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="mahedaotao" style="width: 25%" type="text">
                                    @if ($errors->has('mahedaotao'))
                                    <span class="text-danger">{{ $errors->first('mahedaotao') }}</span>
                                @endif
                                </div>
                            </div>
                        ...
                        <div class="Dep-form d-flex justify-content-center mt-4">
                            ...
                            <div class="mr-3">
                                <a href="{{ route('hedaotao.create') }}" class="btn btn-primary ">Làm mới</a>
                            </div>
                            <div class="mr-3">
                                <a href="{{ route('hedaotao.hedaotao') }}" class="btn btn-danger ">Trở về</a>
                            </div>
                        </div>
                </div>
            </div>
