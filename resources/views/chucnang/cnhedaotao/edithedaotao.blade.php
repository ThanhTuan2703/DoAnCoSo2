        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-12 boder-table">
                    ...
                    <form action="{{ route('hedaotao.update',$eh->mahedaotao)}} " method="post">
                        @csrf
                        @method('put')
                        <div class="container-xl">
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-10">
                                    <input name="tenhedaotao" style="width: 25%" type="text" value="{{$eh->tenhedaotao}}">
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-10">
                                    <input name="mahedaotao" style="width: 25%" type="text" value           ="{{$eh->mahedaotao}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="Dep-form d-flex justify-content-center mt-4">
                            ...
                            <div class="mr-3">
                                <a href="{{ route('hedaotao.edit',$eh->mahedaotao) }}" class="btn btn-primary ">Làm mới</a>
                            </div>
                            <div class="mr-3">
